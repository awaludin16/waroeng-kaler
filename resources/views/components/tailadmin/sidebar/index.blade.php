<aside
    ...
    <x-tailadmin.sidebar.brand>
        <x-slot name="image">
            <img src="./assets/img/logo-ct.png"
                class="inline h-full max-w-full transition-all duration-200 ease-nav-brand max-h-8" alt="main_logo" />
        </x-slot>
        <x-slot name="brand">Waroeng Kaler</x-slot>
    </x-tailadmin.sidebar.brand>

    <hr class="h-px mt-0 bg-transparent bg-gradient-to-r from-transparent via-black/40 to-transparent" />

    <div class="items-center block w-auto h-auto max-h-screen overflow-auto grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            <li class="mt-0.5 w-full">
                <x-tailadmin.sidebar.navlink href="/dashboard" :active="request()->is('dashboard')">
                    <x-slot name="icon">
    ...
    {{-- <div class="mx-4">
        ...
        <p class="invisible hidden text-gray-800 after:bg-gradient-to-tl after:from-gray-900 after:to-slate-800
            </p>
            <div class="after:opacity-65
            after:bg-gradient-to-tl after:from-slate-600 after:to-slate-300 relative flex min-w-0 flex-col items-center
            break-words rounded-2xl border-0 border-solid border-blue-900 bg-white bg-clip-border shadow-none
            after:absolute after:top-0 after:bottom-0 after:left-0 after:z-10 after:block after:h-full after:w-full
            after:rounded-2xl after:content-['']" sidenav-card>
