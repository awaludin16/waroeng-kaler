<x-admin-layout>
    ...
    <div class="overflow-hidden border border-gray-200 rounded-lg shadow-md">
        <!-- Search dan Filter -->
        <div class="flex flex-wrap items-center justify-between px-6 py-4 bg-white border-b gap-4">
            {{-- Search (kiri) --}}
            <div>
            ...
            <tbody class="border-t border-gray-100 divide-y divide-gray-100">
                @forelse ($orders as $item)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-3">{{ \Carbon\Carbon::parse($item->tanggal_pesanan)->format('d F Y, H:i') }}</td>
                        ...
                        <td class="px-6 py-3">
                            ...
                            @else
                                <span class="inline-flex items-center justify-center rounded-full border border-rose-400 px-2.5 py-0.5 text-rose-700">
